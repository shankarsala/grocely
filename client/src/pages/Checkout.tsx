    ...
    return(
      <div className="min-h-screen bg-app-cream flex-center">
         <div className="text-center">
           <h2 className="text-2xl font-semibold text-app-green mb-2">Your Cart is empty</h2>
  ...
  return (
    <div className="min-h-screen bg-app-cream">
     <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
       {/* Back Button */}
       <button onClick={()=> navigate(-1)} className="flex items-center gap-2 text-sm text-sm text-app-text-light hover:text-app-grren mb-6 transition-colors">
       ...
       <div className="grid md:grid-cols-3 gap-6">
         ...
         <div className="bg-white rounded-2xl p-5 h-it sticky top-24">
